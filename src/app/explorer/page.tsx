...
const CATEGORY_CHIP: Record<string, string> = {
  공통과목: "bg-slate-100 text-slate-600 border border-slate-300",
...
const COURSE_GROUPS: Record<string, CourseGroup[]> = {
  ...
  수학: [
    { label: "공통과목", items: ["공통수학1", "공통수학2"] },
    { label: "일반선택", items: ["대수", "미적분Ⅰ", "확률과 통계"] },
    { label: "진로선택", items: ["미적분Ⅱ", "기하", "경제 수학", "인공지능 수학", "직무 수학"] },
    { label: "융합선택", items: ["수학과 문화", "실용 통계", "수학과제 탐구"] },
  ],
};
...
const DUMMY_MAJOR_UNITS: Record<string, string[]> = {
  ...
  통합과학1:             ["1. 물질의 규칙성과 결합", "2. 자연의 구성 물질", "3. 역학적 시스템", "4. 지구 시스템"],
  통합과학2:             ["1. 화학 변화", "2. 생명 시스템", "3. 환경과 에너지", "4. 발전과 신재생 에너지"],
  // 수학 공통과목 (22개정 공식 대단원 — 로마자)
  공통수학1:             ["I. 다항식", "II. 방정식과 부등식", "III. 경우의 수", "IV. 행렬"],
  공통수학2:             ["I. 도형의 방정식", "II. 집합과 명제", "III. 함수와 그래프"],
  // 수학 일반선택 (22개정 공식 대단원 — 로마자)
  대수:                 ["I. 지수함수와 로그함수", "II. 삼각함수", "III. 수열"],
  "미적분Ⅰ":             ["I. 함수의 극한과 연속", "II. 미분", "III. 적분"],
  "확률과 통계":         ["I. 경우의 수", "II. 확률", "III. 통계"],
  // 수학 진로선택 (22개정 공식 대단원 — 로마자)
...
const DUMMY_MINOR_UNITS: Record<string, string[]> = {
  ...
  // ── 수학 공통과목 공통수학1 소단원 (22개정 교육부 공식) ──
  "I. 다항식":                   ["1. 다항식의 연산", "2. 나머지정리와 인수분해"],
  "II. 방정식과 부등식":         ["1. 복소수와 이차방정식", "2. 이차방정식과 이차함수", "3. 여러 가지 방정식과 부등식"],
  "III. 경우의 수":              ["1. 경우의 수", "2. 순열과 조합"],
  "IV. 행렬":                   ["1. 행렬의 뜻과 연산", "2. 행렬의 곱셈"],
  // ── 공통수학2 소단원 ──
  "I. 도형의 방정식":            ["1. 평면좌표", "2. 직선의 방정식", "3. 원의 방정식", "4. 도형의 이동"],
  "II. 집합과 명제":             ["1. 집합", "2. 명제"],
  "III. 함수와 그래프":          ["1. 함수", "2. 유리함수", "3. 무리함수"],
  // ── 대수 소단원 ──
  "I. 지수함수와 로그함수":      ["1. 지수와 로그", "2. 지수함수와 로그함수"],
  "II. 삼각함수":                ["1. 삼각함수", "2. 사인법칙과 코사인법칙"],
  "III. 수열":                   ["1. 등차수열과 등비수열", "2. 수열의 합", "3. 수학적 귀납법"],
  // ── 미적분Ⅰ 소단원 ──
  "I. 함수의 극한과 연속":       ["1. 함수의 극한", "2. 함수의 연속"],
  "II. 미분":                    ["1. 미분계수", "2. 도함수", "3. 도함수의 활용"],
  "III. 적분":                   ["1. 부정적분", "2. 정적분", "3. 정적분의 활용"],
  // ── 확률과 통계 소단원 ──
  "I. 경우의 수":                ["1. 순열과 조합", "2. 이항정리"],
  "II. 확률":                    ["1. 확률의 뜻과 활용", "2. 조건부확률"],
  "III. 통계":                   ["1. 확률분포", "2. 통계적 추정"],
  // ── 미적분Ⅱ 소단원 ──
  "I. 수열의 극한":              ["1. 수열의 극한", "2. 급수"],
  "II. 미분법":                  ["1. 여러 가지 함수의 미분", "2. 여러 가지 미분법", "3. 도함수의 활용"],
  "III. 적분법":                 ["1. 치환적분과 부분적분", "2. 정적분의 활용"],
  // ── 기하 소단원 ──
  "I. 이차곡선":                 ["1. 포물선", "2. 타원", "3. 쌍곡선"],
  "II. 공간도형과 공간좌표":     ["1. 공간도형", "2. 공간좌표"],
  "III. 벡터":                   ["1. 벡터의 연산", "2. 평면벡터의 성분과 내적", "3. 공간벡터"],
  // ── 경제수학 소단원 ──
  "I. 수와 경제":                ["1. 수와 경제지표", "2. 비율과 경제"],
  "II. 함수와 경제":             ["1. 경제 현상의 함수 표현", "2. 경제 함수의 해석"],
  "III. 행렬과 경제":            ["1. 행렬과 경제 현상", "2. 행렬의 응용"],
  "IV. 미분과 경제":             ["1. 한계 개념과 미분", "2. 최적화와 경제"],
  // ── 인공지능 수학 소단원 ──
  "I. 인공지능과 빅데이터":      ["1. 인공지능의 이해", "2. 빅데이터와 수학"],
  "II. 텍스트 데이터 처리":      ["1. 집합과 벡터를 이용한 텍스트 표현", "2. 유사도와 분류"],
  "III. 이미지 데이터 처리":     ["1. 행렬과 합성곱", "2. 이미지 분류"],
  "IV. 예측과 최적화":           ["1. 경향성과 예측", "2. 최적화와 미분"],
};
