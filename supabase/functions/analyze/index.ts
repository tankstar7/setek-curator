...
- limit: "한계: ~. -> [다음 학년]에는 ~ 제안합니다." 형식 고정 (지시사항 4 규칙 적용)
...
interface CreativeActivityGrade {
  academic: string;   // 기록 없으면 "해당 학년 기록 없음", 비공개면 "정보 미제공으로 확인 불가"
  career: string;     // 기록 없으면 "해당 학년 기록 없음", 비공개면 "정보 미제공으로 확인 불가"
  community: string;  // 기록 없으면 "해당 학년 기록 없음", 비공개면 "정보 미제공으로 확인 불가"
}
